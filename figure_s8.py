...
'''
THREE COUNTERSNAPPING ELEMENTS COUPLED IN PARALLEL EXPERIMENT (FIGURE S8, PANELS C,D)
'''
colors = ['#025196', '#4C8E73', '#A0AE54', '#fdb338']
t, u, f = read_force_displacement_data(os.path.join('FIGURE S8', 'Specimen_RawData_1.csv'))
branch_start_indices = [3002, 8306, 10442, 12766, 16221, 20231, 24396]
branch_end_indices = [8296, 10429, 12758, 16212, 20222, 24384, 31882]
branch_cols = [colors[0], colors[1], colors[2], colors[3], colors[2], colors[1], colors[0]]
